...
open.directive('toolBlock', function() {
 ...
 return {
   ...
   link:function(scope,e,a){
     ...
     $(function() {
      ...
      // $(".drawtoolheaders").hover(
      // function(){$(this).toggleClass('active');}
      // );

      // $(".drawtoolheaders").click(
      // function(){$(this).toggleClass('active');}
      // );
      ...
      // $(".toolsDropDownInner").hover(function(){

      //   // $("select.toolsDropDownInner").click(function(){
      //   //     // alert('clicked');
      //   // });

      //   // $('.toolsDropDownInner').click();
      ...
      // // Add hover effect to tools drop down menu for keeping tablet compatibility for buttom click for dropdown
      ...
      // jQuery('toolbarheaderTitle').hover(function() {
      //   jQuery(this).find('.toolsDropDown').stop(true, true).delay(200).fadeIn();
      // }, function() {
      //   jQuery(this).find('.toolsDropDown').stop(true, true).delay(200).fadeOut();
      // });
...
//                      });
   ...
   //link to template-------------------------------------
   templateUrl: 'views/tempTool.html'
