...
open.directive('selProp', function() {
	 ...
	 return {
	   ...
	   link:function(scope,e,a){
	     ...
	     $(function() {
	     	  ...
	     	  //The expand all (mainexpand) icon has been clicked on the SelProp - to expand all sections
	     	  $('.iconic-adjust-mainexpand').click(function() {
	   ...
	   //link to template-------------------------------------
	   templateUrl: 'views/tempSelProp.html'
